    ...
    <div class="card-body card-block">
        <form action="CreateSP_post.php" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="number" id="disabled-input" name="SL" placeholder="Số lượng sản phẩm..."  class="form-control" required>
                </div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9">
                    <input type="number" step=0.001 id="disabled-input" name="GIANHAP" placeholder="Disabled"  class="form-control" required>
                </div>
            ...
            <div class="row form-group">
                <div class="col col-md-3">
                    <label for="select" step=0.001 class=" form-control-label">GIÁ BÁN</label>
                </div>
                <div class="col-12 col-md-9">
                    <input type="nubmer" id="disabled-input" name="GIABAN" placeholder="Disabled"  class="form-control" required>
                </div>
